...
RSpec.describe "Tasks", type: :system do
  ...
  describe 'ログイン前' do
    describe 'ページ移動確認' do
      context 'タスクの新規登録ページに移動' do
        it '新規登録ページへのアクセスが失敗' do
          visit new_task_path
    ...
    describe 'タスク新規登録' do
      context 'フォームの入力値が正常' do
        it 'タスクの新規作成が成功' do
          ...
          fill_in 'Deadline', with: DateTime.new(2021, 5, 10, 14, 50)
          ...
          expect(page).to have_content 'Deadline: 2021/5/10 14:50'
